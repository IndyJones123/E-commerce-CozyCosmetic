...
$rekening = $this->db->get('rekening');
 ...
 <?php echo $this->session->flashdata('subscriber'); ?>
    <footer>
        <div class="subscribe" style="background-color: <?= $this->config->item('subscribe'); ?>">
            <div class="main">
            <div class="text">
                <h2>BERLANGGANAN</h2>
                <p>
            ...
            <div class="form">
                ...
                <input type="text" placeholder="Masukan email kamu" autocomplete="off" name="email" /><!--
                            --><button type="submit" style="background-color: <?= $this->config->item('default_color'); ?>">Subscribe</button>
                </form>
            </div>
            </div>
        </div>
